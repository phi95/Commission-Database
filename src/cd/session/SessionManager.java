...
import cd.persistence.impl.DbUtils;
...
public class SessionManager {
            ...
            throws CDException 
    {
        ...
        try {
            ...
            throw new CDException( "SessionManager.login: Unable to get a database connection" );
        }
            ...
            throws CDException
    {
	    ...
	    //            log.error( "SessionManager.removeSession: cannot close connection", sqe );
            throw new CDException( "SessionManager.removeSession: Cannot close connection" );
        } // try
